    	...
    	<div class="col-mb-5">
	    	...
	    	<form name="newBook" action="processUpdateBook" method="post" enctype="multipart/form-data">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-5">
							<textarea id="description" name="description" cols="50" rows="2" class="form-control" placeholder="100자 이상 적어주세요" ><%= rs.getString("b_description").substring(0, 60) %></textarea>
						</div>
					</div>			
					<div class="mb-3 row">
